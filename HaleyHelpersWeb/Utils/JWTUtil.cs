...
namespace Haley.Utils {
    ...
    public static class JWTUtil {
        ...
        public static async Task<JwtSecurityToken> GetToken(this HttpContext input,string key= "access_token") {
            try {
        ...
        public static async Task<string> GetClaim(this HttpContext context,string claimName, string key = "access_token") {
            var jwt = await context.GetToken(key);
        ...
        public static async Task<string> GetDBA(this HttpContext context) {
            return await context.GetClaim(JWTClaimType.DBA_KEY);
        }
    }
}